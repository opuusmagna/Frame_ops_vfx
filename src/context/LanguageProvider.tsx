...
const routeMapES2EN: Record<string, string> = {
  ...
  '/es/redes-alto-rendimiento/': '/en/high-performance-networking/',
  '/es/servicios/redes-alto-rendimiento/': '/en/services/high-performance-networking/',
  '/es/almacenamiento-datos/': '/en/storage-data-systems/',
  '/es/servicios/almacenamiento-datos/': '/en/services/storage-data-systems/',
  '/es/soluciones/': '/en/solutions/',
  '/es/soluciones-mid-tier/': '/en/solutions-mid-tier/',
  '/es/soluciones-enterprise/': '/en/solutions-enterprise/',
...
const routeMapEN2ES: Record<string, string> = {
  ...
  '/en/high-performance-networking/': '/es/redes-alto-rendimiento/',
  '/en/services/high-performance-networking/': '/es/servicios/redes-alto-rendimiento/',
  '/en/storage-data-systems/': '/es/almacenamiento-datos/',
  '/en/services/storage-data-systems/': '/es/servicios/almacenamiento-datos/',
  '/en/solutions/': '/es/soluciones/',
  '/en/solutions-mid-tier/': '/es/soluciones-mid-tier/',
  '/en/solutions-enterprise/': '/es/soluciones-enterprise/',
